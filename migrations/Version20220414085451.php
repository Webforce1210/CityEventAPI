 ...
 */
final class Version20220414085451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE credit_card_info (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, num_carte VARCHAR(255) NOT NULL, date_expi DATETIME NOT NULL, cvc INT NOT NULL, nom_prenom VARCHAR(255) NOT NULL, INDEX IDX_E670C5E7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, stars INT NOT NULL, cover VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, hobbies LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
